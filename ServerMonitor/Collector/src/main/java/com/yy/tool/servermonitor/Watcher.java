...
public class Watcher {
	...
	private void report() {
		 ...
		 */
		data.put("cpus", hardware.getProcessor().getProcessorCpuLoadBetweenTicks());
		...
		memoryData.put("swapUsed", memory.getSwapUsed());
		memoryData.put("swapTotal", memory.getSwapTotal());
